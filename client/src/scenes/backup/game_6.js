...
//import VueSimpleUpload from 'vue-simple-file-upload'   // FROM https://github.com/Ash-sc/vue-simple-upload
...
export default class Game extends Phaser.Scene {
    ...
    preload() {
        ...
        //this.imagePath = 'https://yasmin-memory-game-server.herokuapp.com/assets/'
        this.imagePath = 'https://cors-anywhere.herokuapp.com/assets/'
